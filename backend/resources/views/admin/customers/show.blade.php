...
<div class="dashboard-content">
    ...
    <section
        ...
        aria-labelledby="orders-summary-heading"
    >
        ...
        >
            ...
            >
                ...
                <h3 style="margin: 8px 0 4px;">
                    {{ number_format($orderSummary['total_orders']) }}
                </h3>
            ...
            >
                ...
                <h3 style="margin: 8px 0 4px;">
                    {{ number_format($orderSummary['pending_orders']) }}
                </h3>
            ...
            >
                ...
                <h3 style="margin: 8px 0 4px;">
                    {{ number_format($orderSummary['completed_orders']) }}
                </h3>
            ...
            >
                ...
                <h3 style="margin: 8px 0 4px;">
                    TSh {{ number_format((float) $orderSummary['total_sales'], 0) }}
                </h3>
                        ...
                        <div>
                            ...
                            @if ($conversation->latestMessage)
                                <div
                                    ...
                                    "
                                >
                                    {{ \Illuminate\Support\Str::limit($conversation->latestMessage->body ?? 'Media message', 100) }}
                                </div>
                            @endif
